        ...
        <div class="w-1/2 bg-school hidden md:block">
            <div class="h-full flex flex-col justify-between p-8 text-white">
                <div class="text-center">
                    <!-- <img src="https://cdn-icons-png.flaticon.com/512/3976/3976626.png" alt="Education Icon" class="h-20 mx-auto mb-4"> -->
        ...
        <div class="w-full md:w-1/2 p-10 bg-gray-50"> <!-- Light gray background for form area -->
            ...
            <form action="login.php" method="POST" class="space-y-6">
                ...
                <div class="flex items-center justify-between">
                    ...
                    <div class="text-sm">
                        <a href="#" class="font-medium text-accent hover:text-accent-dark">Forgot password?</a>
                    </div>
                </div>
            ...
            <div class="mt-8 pt-6 border-t border-gray-200 text-center">
                <p class="text-sm text-gray-500">
                    Need access? <a href="#" class="font-medium text-accent hover:text-accent-dark">Contact your administrator</a>
                </p>
            </div>
        </div>
    </div>
